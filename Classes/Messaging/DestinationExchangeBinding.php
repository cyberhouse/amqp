 ...
 */
class Tx_Amqp_Messaging_DestinationExchangeBinding extends Tx_Amqp_Messaging_Binding {
	...
	public function __construct($destination, $exchange, $routingKey='', array $arguments=array()) {
		parent::__construct($destination, self::DESTINATION_EXCHANGE, $exchange, $routingKey, $arguments);
	}
}
